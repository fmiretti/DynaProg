...
% Level set: restrict the cost-to-go minimization to U^R(x_k)
if obj.UseLevelSet
    % Store the cost-to-go at the level-set-minimizing CV
    cost_MinLevelSetCV = cost(MinLevelSetCV);
    % Set cost-to-go to inf for the unreachable CVs
